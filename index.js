...
// 1. Pornim serverul web pentru Render (obligatoriu pe portul din mediu sau 10000)
const app = express();
...
app.listen(PORT, '0.0.0.0', () => {
    ...
    // 2. Pornim botul de Discord DOAR DUPĂ ce serverul web a deschis portul
    pornesteBotul();
});

function pornesteBotul() {
    ...
    if (!process.env.DISCORD_TOKEN) {
        console.error("❌ EROARE: DISCORD_TOKEN nu este setat în variabilele de mediu!");
    } else {
